...
<body>
	...
	<form action="pg2.php" method="post" enctype="multipart/form-data">
		<div class="row">
...
if (isset($_POST['save'])) {
	...
	if (isset($_COOKIE["name"]) && isset($_COOKIE["meal"]) && isset($_COOKIE["seat"])) {
		...
		echo "Press <a href='pg2(1).php' style='border:1px solid black;padding:4px;'>Go</a> to view Cookie..<br>";
	}else{
		echo "Cookie not set";
	}
}
